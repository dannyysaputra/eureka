    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="flex flex-row">
                <div className="flex-none w-60 h-auto bg-gray-500">
                    <div className="">
                        <div className="flex flex-col h-auto pt-10 px-7">
                            <div className="flex flex-row">
                                <img
                                    ...
                                    alt="Hero"
                                />
                                <div className="font-bold text-xl my-2">Beranda</div>
                            </div>
                            <div className="flex flex-row">
                                <img
                                    style={{ height: "40px", width: "40px" }}
                                    ...
                                    alt="Hero"
                                />
                                <div className="font-bold text-xl my-3">Koleksi</div>
                            </div>
                            <div className="flex flex-row">
                                <img
                                    style={{ height: "40px", width: "40px" }}
                                    ...
                                    alt="Hero"
                                />
                                <div className="font-bold text-xl my-3">Profil</div>
                            </div>
                            <div className="flex flex-row">
                                <img
                                    style={{ height: "40px", width: "40px" }}
                                    ...
                                    alt="Hero"
                                />
                                <div className="font-bold text-xl">Ajukan Pertanyaan</div>
                            </div>
                        </div>
                        
                        <div className="flex flex-col-reverse h-auto place-items-center mt-60">
                            <div className="flex rounded-lg w-44 h-10 mb-6 justify-center" style={{backgroundColor: '#02AF91'}}>
                                <div className="font-bold text-xl my-3 place-content-center">Sign Up</div>    
                            </div>
                            <div className="flex rounded-lg w-44 h-10 mb-2 justify-center" style={{backgroundColor: '#02AF91'}}>
                                <div className="font-bold text-xl my-3 place-content-center">Login</div>
                            </div>                            
                        </div>        
                    </div>                                        
                </div>
                ...
                <div className="flex py-8 px-4">
                    <div className="flex flex-col rounded-xl w-60 h-screen bg-gray-300">
                        ...
                        <div className="flex rounded-xl justify-center p-2 m-4 w-auto h-auto bg-white">
                            <div className=""><p>Disini Pertanyaan</p>
                        ...
                        <div className="flex rounded-xl justify-center p-1 mx-4 w-auto h-auto bg-white">
                            <div className=""><p>Disini Tags nya</p>
